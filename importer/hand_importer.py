...
INSERT INTO public.fact_hand (
    ...
    pot_at_allin, hero_equity_at_allin, hero_chips_invested, allin_adjusted_chips,
    villain_cards,
...
def _to_row(hand: ParsedHand) -> dict:
    return {
        ...
        "hero_chips_invested": hand.hero_chips_invested,
...
class HandImporter:
    ...
    def run(self, batch_size: int = 100) -> None:
        ...
        inserted = duplicates = needs_review = errors = dry_runs = 0
